...
export default async function ProfilePage() {
  // TODO: thay bằng cách lấy userId thực tế (tuỳ dự án bạn: supabase auth, cookie, v.v.)
    ...
    <AuthGate>
      <main className="p-4 space-y-6">
        ...
        {profile ? (
          ...
          <div className="rounded-md border bg-white p-4 text-sm">Không tải được hồ sơ (hoặc chưa có). Vui lòng đăng nhập.</div>
        )}
      </main>
    </AuthGate>
  );
